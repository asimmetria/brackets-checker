...
// is-inner-brackets-useful == false => {(t)} == false, ((t)(t)) == false, ((t)t(t)) == true;

@TestPropertySource(properties = {"properties.is-inner-brackets-useful=false", "properties.regex=[^a-zA-Z0-9а-яА-Я]"})
public class TestCheckerControllerInnerBracketUnuseful extends AbstractTestApi {
        ...
        List<String> texts = new ArrayList<>() {
            {
                ...
                add("(t(t(t(t))))");
                add("{t[t(t{t})]}");
                add("{t[t(t{t})]} {{{[[[[(((((t)t)t)t)t)t]t]t]t]t}t}t}");
                add("{t{t{t[t[t[t[t(t(t(t(t(t)))))]]]]}}} {[({t}t)t]t}");
            }
        };
